    ...
    dashboardBody(
        ...
        fluidRow(
            ...
            box(numericInput(inputId = "serial_num",
                             ...
                             value = 1),
                width = 2),
            box(pickerInput(inputId = "manufacturer",
        ...
        fluidRow(
            box(pickerInput(inputId = "calib_engineer_nm",
                ...
                width = 3),
            box(pickerInput(inputId = "calib_engineer_post",
            ...
            box(pickerInput(inputId = "calib_engineer_nm",
                ...
                width = 3),
            box(pickerInput(inputId = "maintenance_engineer_post",
