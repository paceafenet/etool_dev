...
```{r}
# Use test layout to work in

## UI for each thing

# Try fluid rows

# Need to add logic for things like gps points
...
# Make the reactive values into a df

# View as table - dependent event

# Submit writes to google sheets
```
