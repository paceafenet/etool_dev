...
```{r}
privateData <- ona::onaDownload(formName = "Private_Data_For_Testing", 
                                account = "ona_r", 
                                uname = "ona_r", 
                                pass = "ona_r")  # Only need for private forms

# Creates privateData which is a S3 object with 5 sockets (most importantly data and form)
