...
df <- tibble(serial_num = 1:10000) %>% 
  ...
  mutate(equip_type = sample(c("hiv reagents",
         ...
         long = ifelse(test = maintenance_engineer_post == "affiliate1",
                       yes = 11.502075200000036,
                       no = ifelse(test = maintenance_engineer_post == "affiliate2",
                                   yes = 9.767868700000008,
                                   no = 3.379205700000057)),
         lat = ifelse(test = maintenance_engineer_post == "affiliate1",
